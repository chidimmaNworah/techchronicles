            ...
            <div className="col-lg-8">
              ...
              <div className="bg-white border border-top-0 p-4 mb-3">
                <div className="mb-4">
                  ...
                  <p className="mb-4">
                    Feel free to contact us for your advertising needs, we will
                    send you our media kits and respond to all your enquires
                    within six (6) hours. You can also reach us on Whatsapp and
                    telegram through our telephone number listed below.
                  </p>
                  <div className="mb-3">
                  ...
                  <div className="mb-3">
                    ...
                    <p className="m-0">mail@kimmotechnology.com</p>
                  </div>
                  <div className="mb-3">
                    <div className="d-flex align-items-center mb-2">
