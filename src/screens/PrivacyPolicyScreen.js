  ...
  return (
    <div className="container">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Kimmotech Blog.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Kimmotech Blog, accessible from{' '}
            <a
              href="https://www.kimmotech.blog"
              rel="noreferrer external nofollow noopener"
              target="_blank"
            >
              https://www.kimmotech.blog
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <strong>
            PRequest correction of the Personal Data that We hold about You.
          </strong>
      ...
      <ul>
        <li>
          <p>By email: mail@kimmotechnology.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{' '}
            <a
              href="https://www.kimmotech.blog/contact"
              rel="noreferrer external nofollow noopener"
              target="_blank"
            >
              https://www.kimmotech.blog/contact
            </a>
          </p>
        </li>
      </ul>
